...
LAMBDA="${LAMBDA:-lab4-form-fill-forwarder}"
SCHEDULE_NAME="${SCHEDULE_NAME:-lab4-form-fill-daily}"
TIMEZONE="${TIMEZONE:-America/Los_Angeles}"     # <-- set YOUR timezone; default is NOT UTC on purpose
SCHEDULER_ROLE_ARN="${SCHEDULER_ROLE_ARN:-arn:aws:iam::${ACCOUNT}:role/lab4-scheduler-invoke}"
